      ...
      <div className="container mx-auto px-4">
        ...
        <LogoSVG 
          ...
          <div>
            ...
            <p className="text-gray-600">Email: glitterproductions24@gmail.com</p>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://instagram.com/glitter_prod" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-pink-400 transition-colors">
                <Instagram size={24} />
              </a>
              <a href="mailto:glitterproductions24@gmail.com" className="text-gray-600 hover:text-pink-400 transition-colors">
                <Mail size={24} />
              </a>
            </div>
          </div>

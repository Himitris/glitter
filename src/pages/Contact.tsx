  ...
  return (
    <div>
      <PageHeader
        ...
        backgroundImage="https://images.unsplash.com/photo-1508997449629-303059a039c0?w=1600&auto=format&fit=crop&q=80"
      />
              ...
              <form className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full px-4 py-3 bg-gray-800/50 border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF4D8F] focus:border-transparent text-white"

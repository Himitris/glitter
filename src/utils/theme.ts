// Système de couleurs - Charte graphique Glitter Productions 2025
export const colors = {
  // Couleurs primaires
  primary: {
  ...
  text: {
    ...
    gradient:
      "bg-gradient-to-r from-[#775CFF] via-[#EBABFF] via-[#FF7A42] to-[#FFFF73] text-transparent bg-clip-text",
  },
} as const;
...
export const components = {
  card: {
    ...
    borderViolet:
      "border-transparent bg-gradient-to-br from-[#775CFF] to-[#EBABFF] p-[2px]",
    borderRose:
      "border-transparent bg-gradient-to-br from-[#EBABFF] to-[#FF7A42] p-[2px]",
    borderJaune:
      "border-transparent bg-gradient-to-br from-[#FFFF73] to-[#EBABFF] p-[2px]",
    borderOrange:
      "border-transparent bg-gradient-to-br from-[#FF7A42] to-[#EBABFF] p-[2px]",
...
export const artistStyles = {
  card: {
    ...
    content:
      "grid md:grid-cols-2 bg-gradient-to-r from-[#775CFF] via-[#EBABFF] to-[#FF7A42]",

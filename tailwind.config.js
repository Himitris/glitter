...
export default {
  ...
  theme: {
    extend: {
      // Couleurs de la charte graphique Glitter Production 2025
      colors: {
        'glitter': {
          // Couleurs primaires
          'off-white': '#FFFFF6',
      ...
      boxShadow: {
        'glow-violet': '0 0 20px rgba(119, 92, 255, 0.4), 0 0 40px rgba(119, 92, 255, 0.2)',
        'glow-rose': '0 0 20px rgba(235, 171, 255, 0.4), 0 0 40px rgba(235, 171, 255, 0.2)',
        'glow-orange': '0 0 20px rgba(255, 122, 66, 0.4), 0 0 40px rgba(255, 122, 66, 0.2)',
        'glow-jaune': '0 0 20px rgba(255, 255, 115, 0.4), 0 0 40px rgba(255, 255, 115, 0.2)',
      },
    },
  },
  plugins: [],
